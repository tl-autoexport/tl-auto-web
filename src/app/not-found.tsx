    ...
    <main className="min-h-screen bg-[#f4f5f7] text-[#121722]">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-108px)] max-w-7xl items-center px-5 py-12">
        <div className="grid w-full overflow-hidden rounded-md bg-white shadow-sm ring-1 ring-[#d8dde6] lg:grid-cols-[0.8fr_1.2fr]">
          <div className="relative flex min-h-64 items-center justify-center overflow-hidden bg-[#11151d] p-10 text-white lg:min-h-[480px]">
            ...
            <div className="relative text-center">
              <SearchX className="mx-auto text-[#d8bd75]" size={44} strokeWidth={1.7} aria-hidden="true" />
          ...
          <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
            <p className="text-xs font-bold uppercase tracking-wide text-[#956f2c]">
              TL Auto
            </p>
